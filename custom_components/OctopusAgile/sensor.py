...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    add_entities([PreviousExportRate(hass)])
    add_entities([CurrentExportRate(hass)])
    add_entities([NextExportRate(hass)])
    add_entities([MaxExportRate(hass)])
...
class PreviousExportRate(Entity):
    """Representation of a Sensor."""
    ...
    def name(self):
        """Return the name of the sensor."""
        return 'Octopus Agile Previous Export Rate'
    ...
    def update(self):
        ...
        # # attributes['date_to']
        # self._attributes = attributes
        rate = round(self.myrates.get_previous_export_rate(), 2)
        self._state = rate

class CurrentExportRate(Entity):
    """Representation of a Sensor."""
    ...
    def name(self):
        """Return the name of the sensor."""
        return 'Octopus Agile Current Export Rate'
    ...
    def update(self):
        ...
        # # attributes['date_to']
        # self._attributes = attributes
        rate = round(self.myrates.get_current_export_rate(), 2)
        self._state = rate

class NextExportRate(Entity):
    """Representation of a Sensor."""
    ...
    def name(self):
        """Return the name of the sensor."""
        return 'Octopus Agile Next Export Rate'
    ...
    def update(self):
        ...
        # # attributes['date_to']
        # self._attributes = attributes
        rate = round(self.myrates.get_next_export_rate(), 2)
        self._state = rate


class MaxExportRate(Entity):
    """Representation of a Sensor."""
    ...
    def update(self):
        ...
        # # attributes['date_to']
        # self._attributes = attributes
        new_rates = self.myrates.get_new_export_rates()["date_rates"]
        rate_dict = self.myrates.get_max_times(1, new_rates)
        rate = round(rate_dict[next(iter(rate_dict))], 2)
        # rate = round(self.myrates.get_next_rate(), 2)
        self._state = rate
